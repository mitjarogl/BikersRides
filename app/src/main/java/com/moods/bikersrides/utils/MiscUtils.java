...
public final class MiscUtils {
     ...
     * @param cl      class-loader to use. Use {@link Context#getClassLoader()} to obtain one.
     ...
     *
     * @param dir the directory to delete. For safety reasons it must start with
     *            /sdcard/aedict
     * @throws IOException
     */
     ...
     *
     * @param dir the directory to list. A directory length is set to be 4kb +
     ...
     * closed.
     *
     * @param in read this stream. Always closed.
